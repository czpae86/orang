...
(function(){
    ...
    orang.initConfig = function(opts){
        if(tools.isObject(opts)){
            serverConfig.protocolType = tools.isEmpty(opts.protocolType)?serverConfig.protocolType:opts.protocolType;
        ...
        root.server = (function(){
            ...
            var server;
            if(serverConfig.protocolType.toLowerCase() == "http"){
                server = http.createServer(handler);
            }else if(serverConfig.protocolType.toLowerCase() == "https"){
